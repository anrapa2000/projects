  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 p-6 bg-white rounded shadow">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <input {...register('position')} placeholder="Position" className="input" required />
        <input type="date" {...register('dateApplied')} className="input" required />
        <textarea {...register('shortDescription')} placeholder="Short Description" className="input" />
        <textarea {...register('longDescription')} placeholder="Full Job Description" className="input" />
        ...
        <textarea {...register('notes')} placeholder="Additional Notes" className="input" />
